...
async function LifestyleGrid() {
  const products = await getProductsByCategory("lifestyle")
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-playfair font-bold mb-6">Lifestyle</h1>
            <p className="text-xl sm:text-2xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">
              Curated essentials for modern living that enhance your daily rituals and personal spaces
            </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
              <h2 className="text-2xl font-semibold text-gray-900">All Lifestyle ({products.length})</h2>
              <select className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white">
